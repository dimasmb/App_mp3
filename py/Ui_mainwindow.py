...
"    }")
        ...
        self.label_song_time = QtWidgets.QLabel(self.centralwidget)
        self.label_song_time.setMaximumSize(QtCore.QSize(16777215, 10))
        self.label_song_time.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_song_time.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_song_time.setObjectName("label_song_time")
        self.horizontalLayout_3.addWidget(self.label_song_time)
    ...
    def retranslateUi(self, MiMP3):
        ...
        self.label_song_time.setText(_translate("MiMP3", "-- / --"))
        self.radioButton_3.setText(_translate("MiMP3", "Normal"))
        self.radioButton_4.setText(_translate("MiMP3", "Jazz"))
        self.radioButton_2.setText(_translate("MiMP3", "Classic"))
        self.radioButton.setText(_translate("MiMP3", "Rock"))
